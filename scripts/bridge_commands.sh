...
#    python create_bridge_data.py    /home/development/anoop/experiments/unsupervised_transliterator/data/nonparallel_old/tmp/create_test_corpus/NEWS_2015_exclusive/$src_lang-$tgt_lang/train.En-$src_lang $outdir/En-$src_lang/train.En $outdir/En-$src_lang/train.$src_lang
#
#    mkdir -p $outdir/En-$tgt_lang
#    python create_bridge_data.py    /home/development/anoop/experiments/unsupervised_transliterator/data/nonparallel_old/tmp/create_test_corpus/NEWS_2015_exclusive/$src_lang-$tgt_lang/train.En-$tgt_lang $outdir/En-$tgt_lang/train.En $outdir/En-$tgt_lang/train.$tgt_lang
#done
#
